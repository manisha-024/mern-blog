  ...
  return (
    <>
      ...
      <div className="block sm:hidden">
        <div className='relative w-full border border-pink-800 h-auto overflow-hidden rounded-lg transition-all mx-auto'>
          ...
          <div className='p-4 flex flex-col gap-3'>
            ...
            <Link
              to={`/post/${post.slug}`}
              className='border border-pink-800 text-pink-800 hover:bg-pink-800 hover:text-white active:bg-teal-600 active:text-white transition-all duration-200 text-center py-2 px-4 rounded-md font-medium'
            >
              Read article
            </Link>
          </div>
